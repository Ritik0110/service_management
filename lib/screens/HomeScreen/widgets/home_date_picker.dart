          ...
          Positioned(
            ...
            child: InkWell(
              onTap: () {
               ...
               showDatePicker(context: context, initialDate: homeController.selectedDate.value, firstDate: DateTime.now().subtract(Duration(days: 365)), lastDate: DateTime.now().add(Duration(days: 365))).then((value) {
                 if(value != null){
